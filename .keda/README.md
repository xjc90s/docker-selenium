...
```bash
docker pull selenium/keda:2.16.1-selenium-grid-20250123
docker pull selenium/keda-metrics-apiserver:2.16.1-selenium-grid-20250123
docker pull selenium/keda-admission-webhooks:2.16.1-selenium-grid-20250123
```
...
```yaml
  image:
    keda:
      registry: selenium
      repository: keda
      tag: "2.16.1-selenium-grid-20250123"
    metricsApiServer:
      registry: selenium
