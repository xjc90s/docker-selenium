...
![Version: 0.39.0](https://img.shields.io/badge/Version-0.39.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.28.0-20250120](https://img.shields.io/badge/AppVersion-4.28.0--20250120-informational?style=flat-square)
...
| global.seleniumGrid.imageTag | string | `"4.28.0-20250120"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.28.0-20250120"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-7.1-20250120"` | Image tag for browser's video recorder |
...
| keda.image | object | `{"keda":{"registry":"selenium","repository":"keda","tag":"2.16.1-selenium-grid-20250120"},"metricsApiServer":{"registry":"selenium","repository":"keda-metrics-apiserver","tag":"2.16.1-selenium-grid-20250120"},"webhooks":{"registry":"selenium","repository":"keda-admission-webhooks","tag":"2.16.1-selenium-grid-20250120"}}` | Specify image for KEDA components |
