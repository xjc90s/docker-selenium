...
![Version: 0.39.1](https://img.shields.io/badge/Version-0.39.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.28.1-20250123](https://img.shields.io/badge/AppVersion-4.28.1--20250123-informational?style=flat-square)
...
| https://prometheus-community.github.io/helm-charts | kube-prometheus-stack | 68.3.0 |
...
| global.seleniumGrid.imageTag | string | `"4.28.1-20250123"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.28.1-20250123"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-7.1-20250123"` | Image tag for browser's video recorder |
...
| keda.image | object | `{"keda":{"registry":"selenium","repository":"keda","tag":"2.16.1-selenium-grid-20250123"},"metricsApiServer":{"registry":"selenium","repository":"keda-metrics-apiserver","tag":"2.16.1-selenium-grid-20250123"},"webhooks":{"registry":"selenium","repository":"keda-admission-webhooks","tag":"2.16.1-selenium-grid-20250123"}}` | Specify image for KEDA components |
